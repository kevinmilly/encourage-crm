...
export class AddContactComponent {
  ...
  contactTypeChoices:ChoiceValue[];

  contextKnownFrom:ChoiceValue[];

  energyLevels:ChoiceValue[];

  priorities:ChoiceValue[];

  statuses:ChoiceValue[];
